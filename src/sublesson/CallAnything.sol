...
// The "function selector" is the first 4 bytes of the function signature (ex. 0xa9059cbb)
// The "function signature" is a string that defines the function name & parameters (ex. "transfer(address,uint256)")
// Let's look at this
